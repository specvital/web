...
// BehaviorCacheStats defines model for BehaviorCacheStats.
type BehaviorCacheStats struct {
	// CachedBehaviors Number of behaviors retrieved from cache
	CachedBehaviors int `json:"cachedBehaviors"`

	// GeneratedBehaviors Number of behaviors generated by AI
	GeneratedBehaviors int `json:"generatedBehaviors"`

	// HitRate Cache hit rate (0.0 to 1.0)
	HitRate float32 `json:"hitRate"`

	// TotalBehaviors Total number of behaviors in the spec document
